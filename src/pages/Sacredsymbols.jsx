...
const Sacredsymbols = () => {
  ...
  return (
    <section 
      ...
      className="pt-24 border-t relative" /* Fixed pt-30 to standard pt-24 */
    >
      <NavBar />
      
      {/* Added horizontal padding (px-6 md:px-8) and bottom padding (pb-24) for safe viewport framing */}
...
>
  ...
  <div className="flex gap-8 flex-col sm:flex-row items-start">
    ...
    {/* EXPANDED GRAPHIC CONTAINER: Increased to w-32 / sm:w-40 for better visibility */}
  ...
  >
    ...
    <div className="flex gap-x-6 gap-y-3 flex-wrap">
      ...
      <footer className="w-full text-center py-8 text-xs text-slate-400 border-t border-slate-200 bg-white absolute bottom-0 left-0 right-0">
